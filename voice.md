...
it.» (одиничність = теза) · «A match is still two questions away.» (буквальні два поля; до 2026-09-17 стояло «three» — розходилось із формою) ·
...
## Рішення уроку 07 (2026-09-17)

**Вигадані марки партнерів дозволено** (R1, рішення користувача). CLAUDE.md §6.1 забороняє
називати **реальну** компанію партнером Asterra і прямо дозволяє вигадані бренди на етапі
дизайну. Канон імен — `microcopy.md`, «Урок 07 · крок 6». Правило для нових імен: перевірити
пошуком, що такої компанії чи бренду не існує; назва + категорія завжди поруч (марка без
категорії — логостіна без осі).

**Дати** (R3): дата, що належить нормі, — публічний факт і пишеться (з днем); дата, що
належала б вигаданому бренду (публікація новини, редакція документа), — `[TBD — no source]`.
