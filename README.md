...
- **Applied to wireframes:** [`wireframes/_archive/_panel.css`](./wireframes/_archive/_panel.css) on top of the
...
- **Geometry pass over the rendered pages:** [`wireframes/_archive/_parts/_GEOMETRY.md`](./wireframes/_archive/_parts/_GEOMETRY.md) —
...
The screens are assembled from one kit — no page carries its own styles.

- **Language, documented from code:** [`DESIGN.md`](./DESIGN.md) — generated by
  `/impeccable document` from the painted screens and kept in sync with the kit; every kept
